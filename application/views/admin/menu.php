      ...
      <div class="row no-gutters">
            ...
            <div class="col-md-8">
              <div class="card-body">
                ...
                <a href="<?= base_url('admin/updateMenu/' . $mn->id); ?>"  data-toggle="modal" data-target="#ModalUpdate" style="padding: 5px; background-color:green; color:white; margin-left: 1vw;"> Update </a>
              </div>
            </div>
      </div>
    </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?= base_url('admin/update_process'); ?>" method="POST">
          <div class="form-group">
          <input type="text" name="product_id" value="<?php $id; ?>">
          </div>
          <div class="form-group">
            <label for="name" class="col-form-label">Name:</label>
